% !TeX document-id = {a3f5b1d0-79dd-4fc2-8279-d3333545bdf0}
% !TeX program  = XeLaTeX
% !TeX encoding = UTF-8

\documentclass[type=master]{YNUthesis} % 硕士学位
%\documentclass[type=doctor]{YNUthesis} % 博士学位
\usepackage{YNUlogo}
\usepackage{booktabs}
\usepackage{zhlipsum}
...
\YNUsetup{
  ...
  style = {
    ...
    % 超链接颜色
    % 允许选项：
    %   hyperlink-color = default|classic|material|graylevel|prl|black
    %
    bib-backend = bibtex,
    % 参考文献支持方式
    % 允许选项：
